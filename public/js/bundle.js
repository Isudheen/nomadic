...
var editTour = document.querySelector('.form-tour-data');
var editUser = document.querySelector('.form-user-data-admin');
...
if (editTour) editTour.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (editUser) editUser.addEventListener('submit', function (e) {
  e.preventDefault();
