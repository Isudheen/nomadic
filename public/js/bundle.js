 ...
 */
    ...
    '../../node_modules/axios/lib/helpers/toFormData.js': [
      function (require, module, exports) {
        ...
        var _FormData = _interopRequireDefault(
          require('../env/classes/FormData.js')
        );
        function _interopRequireDefault(obj) {
          return obj && obj.__esModule ? obj : { default: obj };
        }
        ...
        function isSpecCompliant(thing) {
          return (
            thing &&
            _utils.default.isFunction(thing.append) &&
    ...
    '../../node_modules/axios/lib/adapters/index.js': [
        ...
        var _default = {
          getAdapter: (nameOrAdapter) => {
            if (_utils.default.isString(nameOrAdapter)) {
              ...
              if (!nameOrAdapter) {
                throw Error(
                  _utils.default.hasOwnProp(nameOrAdapter)
      ...
      {
        '../utils.js': '../../node_modules/axios/lib/utils.js',
        './http.js': '../../node_modules/axios/lib/adapters/xhr.js',
      ...
      function (require, module, exports) {
        ...
        function getDefaultAdapter() {
          ...
          if (typeof XMLHttpRequest !== 'undefined') {
            ...
            _utils.default.kindOf(process) === 'process'
          ) {
      ...
      function (require, module, exports) {
        ...
        class Axios {
          ...
          request(configOrUrl, config) {
            ...
            config.headers = new _AxiosHeaders.default(
              config.headers,
              defaultHeaders
            );
    ...
    '../../node_modules/axios/lib/axios.js': [
      function (require, module, exports) {
        ...
        axios.formToJSON = (thing) => {
          return (0, _formDataToJSON.default)(
