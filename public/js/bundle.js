      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.msg);
          case 10:
          case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51M2AdzSE44uz4WeNbleyCecAqM5p7HECJrGRgQnmX6xl0ELqiqfX7maeG2eFigyWQlvH5si15SBzPuDBNqzRay2V00P0HP39nJ');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            (0, _alerts.showAlert)('success', 'Creating your new shiny✨ account');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            window.setTimeout(function () {
              location.assign("/mobile-otp-verify/".concat(mobile));
            }, 1500);
            _context.next = 11;
            break;
          case 8:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"tourUpdate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tourEdit = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var tourEdit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, price, duration, difficulty, maxGroupSize, summary, description, slug, id) {
    var url;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            (0, _alerts.showAlert)('success', 'Tour Updated');
            _context.next = 11;
            break;
          case 7:
            _context.prev = 7;
  ...
  return function tourEdit(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
exports.tourEdit = tourEdit;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"userUpdate.js":[function(require,module,exports) {
"use strict";
...
var userEdit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, active, role, id) {
    var url;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            (0, _alerts.showAlert)('success', 'User Updated');
            _context.next = 10;
            break;
          case 7:
            _context.prev = 7;
  ...
  return function userEdit(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
exports.userEdit = userEdit;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"reviewUpdate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reviewEdit = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var reviewEdit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, id) {
    var url;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function reviewEdit(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
exports.reviewEdit = reviewEdit;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"reviewCreate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reviewPost = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var reviewPost = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "/api/v1/tours/".concat(tour, "/reviews");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
              url: url,
          ...
          case 4:
            (0, _alerts.showAlert)('success', 'Review Created ✨✨');
            _context.next = 10;
            break;
          case 7:
            _context.prev = 7;
  ...
  return function reviewPost(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
exports.reviewPost = reviewPost;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"otp.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mobileOtpSend = exports.mobileOtpLogin = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var mobileOtpSend = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(mobile, action) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            (0, _alerts.showAlert)('success', 'OTP Send Successfully');
            window.setTimeout(function () {
              location.assign("/mobile-otp-verify/".concat(mobile));
            }, 1000);
            _context.next = 12;
  ...
  return function mobileOtpSend(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.mobileOtpSend = mobileOtpSend;
var mobileOtpLogin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(mobile, otp) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 3:
            (0, _alerts.showAlert)('success', 'OTP verification success 😎');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
            _context2.next = 11;
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context2.t0.response.data.msg);
          case 11:
          case "end":
            return _context2.stop();
        }
  ...
  return function mobileOtpLogin(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.mobileOtpLogin = mobileOtpLogin;
...
var _tourUpdate = require("./tourUpdate");
var _userUpdate = require("./userUpdate");
var _reviewUpdate = require("./reviewUpdate");
var _reviewCreate = require("./reviewCreate");
...
var signUpForm = document.querySelector('.sign_up-form');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var editTourForm = document.querySelector('.form-tour-data');
var editUserForm = document.querySelector('.form-user-data-admin');
var editReviewForm = document.querySelector('.form-user-review-data');
var createReviewForm = document.querySelector('.form-user-review-create');
var otpSendForm = document.querySelector('.form-otp-send');
var otpVerifyLoginForm = document.querySelector('.form-otp-verify');
//values
...
if (editTourForm) editTourForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  var maxGroupSize = document.getElementById('tour-size').value;
  var summary = document.getElementById('tour-summary').value;
  var description = document.getElementById('tour-description').value;
  var slug = document.getElementById('tour-slug').value;
  var id = document.querySelector('.tour_id').textContent;
  (0, _tourUpdate.tourEdit)(name, price, duration, difficulty, maxGroupSize, summary, description, slug, id);
});
if (editUserForm) editUserForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('user-name').value;
  var email = document.getElementById('user-email').value;
  var active = document.getElementById('user-active').value;
  var role = document.getElementById('user-role').value;
  var id = document.querySelector('.user_id').textContent;
  (0, _userUpdate.userEdit)(name, email, active, role, id);
});
